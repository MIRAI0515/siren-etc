...
input_image_path2 = '/mnt/siren/explore_siren/trained_siren_240613_2204_EGFP_2048/2048_model_output.tiff'
pixel = 128  # 変更
...
# 画像サイズの比率を計算
scaling_factor = image_np2.shape[0] / image_np1.shape[0]  # image1に対してimage2のサイズ比率を計算
...
def update_brightness_graph(row, col):
    ...
    brightness_values2, cropped_image2 = update_brightness(row, col, image_np2, pixel, scaling_factor)
