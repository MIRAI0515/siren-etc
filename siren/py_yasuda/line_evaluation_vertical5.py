...
# 画像のパスを指定
input_image_path1 = '/mnt/siren/mip_nd2_yasuda/Ex03_No.14_PBS_SHG_ELN_FBN_DAPI_880nm003_MIP/240613_2204_EGFP_128_212_668.tiff'  # 1つ目の画像 # 212_668
input_image_path2 = '/mnt/siren/mip_nd2_yasuda/Ex03_No.14_PBS_SHG_ELN_FBN_DAPI_880nm003_MIP/240613_2204_EGFP_resized_64x64_no_resize_212_668.tiff'  # 2つ目の画像
input_image_path3 = '/mnt/siren/explore_siren/experiment_240613_2204_EGFP_resized_64x64_no_resize_212_668_sine_10000_w30_128/128_model_output.tiff'  # 3つ目の画像
input_image_path4 = '/mnt/siren/mip_nd2_yasuda/Ex03_No.14_PBS_SHG_ELN_FBN_DAPI_880nm003_MIP/240613_2204_EGFP_resized_64x64_no_resize_212_668_opencv_resize128.tiff'  # 4つ目の画像
# input_image_path4 = '/mnt/siren/mip_nd2_yasuda/trained_siren_240613_2204_EGFP_resized_512x512_no_resize_sine_10000_uw30_w30_1024_235_831_128.tiff'  # 4つ目の画像
...
def update_brightness_vertical(row, col, image_np, scaling_factor=1):
    ...
    if 0 <= row < image_np.shape[0]:
        brightness_values = image_np[0:128, col]
...
def update_brightness_graph_vertical(row, col):
    ...
    brightness_values2= update_brightness_vertical(row, col, image_np2, scaling_factor1)
    # brightness_values3, cropped_image3 = update_brightness_vertical(row, col, processed_image3, pixel, scaling_factor2)
    brightness_values3 = update_brightness_vertical(row, col, image_np3, scaling_factor2)
    brightness_values4 = update_brightness_vertical(row, col, image_np4, scaling_factor3)
    ...
    ax_crop1.imshow(image_np1, cmap='gray')
    ...
    ax_crop2.imshow(image_np2, cmap='gray')
    ...
    ax_crop3.imshow(image_np3, cmap='gray')
    ...
    ax_crop4.imshow(image_np4, cmap='gray')
