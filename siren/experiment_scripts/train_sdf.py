...
p.add_argument('--experiment_name', type=str, default="experiment_2407012206",#experiment_line_1_10_20_xyznxnynz_4_60
               help='Name of subdirectory in logging_root where summaries and checkpoints will be saved.')

# General training options
p.add_argument('--batch_size', type=int, default=1400)#default 1400
...
p.add_argument('--point_cloud_path', type=str, default='/mnt/siren/xyz_yasuda/bar_0.2_10_50_20_5_1.5_xyznxnynz_4_60.xyz',
               help='Options are "sine" (all sine activations) and "mixed" (first layer sine, other layers tanh)')
...
#dataloader = DataLoader(sdf_dataset, shuffle=True, batch_size=1, pin_memory=True, num_workers=1)
