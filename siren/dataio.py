...
class Collagen(Dataset): #()の中のDatasetは、親。
    def __init__(self, downsample_factor=1):#__init__()は準備
        super().__init__()
        self.downsample_factor = downsample_factor
        self.img =Image.open('/mnt/siren/mip_nd2_yasuda/Ex03_No.14_PBS_SHG_ELN_FBN_DAPI_880nm003_MIP/240613_2204_EGFP_resized_512x512_no_resize.tiff').convert('L')# 変更箇所
